		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ASPNo1_Coffee",
									"targetURL": "#aspno1coffee-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aspno1coffee-display": {
								"semanticObject": "aspno1coffee",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aspno1coffee",
									"url": sap.ui.require.toUrl("aspno1coffee")
								}
							}
						}
					}
